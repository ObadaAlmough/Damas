        ...
        <div class="main-header-right">
                    ...
                    <div class=" d-md-flex">
                        ...
                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            @if (App::getlocale() != $localeCode)
                                <a class="text-dark list-group d-flex  nav-item nav-link pl-0 country-flag1"
                                    rel="alternate" hreflang="{{ $localeCode }}"
                                    href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">

                                    <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img
                                            src="{{ URL::asset("assets/img/flags/$localeCode.jpg") }}" alt="img">
                                    </span>
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="nav-item d-flex align-items-center">
                    <a class="new nav-link  text-dark" href="{{url()->previous()}}">
                        <i class="far fa-arrow-alt-circle-left h3"></i></a>
                </div>
                {{-- back  --}}
            </div>
        </div>
